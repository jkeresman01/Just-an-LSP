...
{
    completions.emplace_back("dnsClient", "DNS client test 1", "DNS client test 1 documentation",
                             "dnsClient");
    completions.emplace_back("dnsClientId", "DNS client test 1", "DNS client id test 1 documentation",
                             "dnsClientId");
