...
class MessageFactory
{
  public:
    ...
    ///
    //////////////////////////////////////////////////////////////
    static std::shared_ptr<RequestMessage> createInitializeReq(const nlohmann::json &jsonRPC)
    {
    ...
    ///
    //////////////////////////////////////////////////////////////
    static std::shared_ptr<RequestMessage> createDidChangeTextDocumentReq(const nlohmann::json &jsonRPC)
    {
